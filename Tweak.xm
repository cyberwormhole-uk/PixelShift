...
// Uses UIWindowScene.windows (the non-deprecated replacement for
// UIApplication.windows, required since iOS 15) since this project's
// deployment target is already iOS 15+.
